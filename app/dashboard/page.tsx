...
async function getHouseholds() {
  ...
  console.log('=== SSR DASHBOARD DEBUG ===')
  ...
  try {
    ...
    console.log('Cookie being sent:', `better-auth.session_token=${sessionToken.value}`)
    ...
    if (!res.ok) {
      console.log('❌ Failed to fetch households (status:', res.status, '), redirecting to login')
      redirect('/')
    }
